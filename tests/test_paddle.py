...
class TestPaddleLogic(unittest.TestCase):
    def setUp(self):
        self.paddle = PaddleLogic(0, 0)

    def test_initial_position(self):
        self.assertEqual(self.paddle.position(), (0, 0))

    def test_move_up(self):
        self.paddle.up()
        self.assertEqual(self.paddle.position(), (0, 10))
    ...
    def test_upper_boundary(self):
        self.paddle.y = 240
        self.paddle.up()
        self.assertEqual(self.paddle.position(), (0, 240))
